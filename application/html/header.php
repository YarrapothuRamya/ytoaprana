...
<div class="topwrap">
	...
	<!-- background:url(../images/icn_user.png) no-repeat 10px 9px #ecf5fb;-->
		...
		<?php $avatar=getdata('va_employees','emp_avatar','emp_id='.$ERP_Uid); 
		if(!empty($avatar)) {
		?>
		<img src="<?=BASEURLF."uploads/emp_photos/".$avatar ?>" height="10" >
		<?php } ?>
		<?=$_SESSION['ERP_Uname'];?>
        ...
        <div id="mymenu" class="dropdown dropdown-tip dropdown-anchor-right">
        	<ul class="dropdown-menu">
				<!--li><img src="<?//=BASEURLF."uploads/emp_photos/".$avatar ?>" height="80"></li-->
...
<div class="logowrap" style="background:#ffffff; padding:10px 0;">
    ...
    <span class="logo_weberp4" style=" background:#FFFFFF"><a href="http://www.weberp4.com" target="_blank"><img src="<?=BASEURL.ERPLOGO?>" alt="<?php echo ERPTITLE;?>" width="auto" height="" align="absmiddle"></a></span>
  <div class="clear"></div>
</div>
<div class="clear"></div>