  ...
  <tr>
    <td align="left" colspan="2"><h3 class="title">Contact Details</h3></td>
         ...
         <tr>
          ...
          <td><?=$vrow['doc_office'];?></td>
        </tr>
         <tr>
          <td nowrap="nowrap"><strong>Mobile Number</strong></td>
          <td><?=$vrow['doc_phone'];?></td>
        </tr>
         <tr>
          <td nowrap="nowrap"><strong>E-Mail ID</strong></td>
          <td><?=$vrow['doc_email'];?></td>
        </tr>
         <tr>
          <td nowrap="nowrap"><strong>UserName</strong></td>
          <td><?=$vrow['doc_username'];?></td>
        </tr>
		<tr>
          <td nowrap="nowrap"><strong>Password </strong></td>
          <td><?=rnsb64ende($vrow['doc_password'],1);?></td>
        </tr>
        <tr>
          <td nowrap="nowrap"><strong>Added On</strong></td>
          <td><?=dd_mm_yyyy($vrow['doc_added_date']);?></td>
        </tr>                       
      </tbody>
    </table></td>
    </tr>
    <tr>
    <td align="center"><h3 class="title">Doctor - Transaction Details</h3></td>
  </tr>
   <tr>
    <td valign="top">
