...
<table width="100%" border="0" cellpadding="0" cellspacing="5">
  <tr>
    <td align="center"><h3 class="title">Pharma - Registration Details</h3></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-bordered">
      <tr>
        <td width="20%" nowrap="nowrap"><strong>Name of the Pharma</strong></td>
        <td><?=$vrow['pharma_name'];?></td>
      </tr>
      <tbody>
        <tr>
          <td nowrap="nowrap"><strong>Registration Number </strong></td>
          <td><?=$vrow['pharma_refno'];?></td>
        </tr>
  <tr>
  ...
  <tr>
    <td align="left" colspan="2"><h3 class="title">Contact Details</h3></td>
         ...
         <tr>
          ...
          <td><?=$vrow['pharma_office'];?></td>
        </tr>
         <tr>
          <td nowrap="nowrap"><strong>Mobile Number</strong></td>
          <td><?=$vrow['pharma_phone'];?></td>
        </tr>
         <tr>
          <td nowrap="nowrap"><strong>E-Mail ID</strong></td>
          <td><?=$vrow['pharma_email'];?></td>
        </tr>
         <tr>
          <td nowrap="nowrap"><strong>UserName</strong></td>
          <td><?=$vrow['pharma_username'];?></td>
        </tr>
		<tr>
          <td nowrap="nowrap"><strong>Password </strong></td>
          <td><?=rnsb64ende($vrow['pharma_password'],1);?></td>
        </tr>
        <tr>
          <td nowrap="nowrap"><strong>Added On</strong></td>
          <td><?=dd_mm_yyyy($vrow['pharma_added_date']);?></td>
        </tr>                       
      </tbody>
    </table></td>
    </tr>
    <tr>
    <td align="center"><h3 class="title">Pharma - Transaction Details</h3></td>
  </tr>
   <tr>
    <td valign="top">
