<div class="tablecontent">
  ...
  <div class="box addeditform">
    <h3 class="title">ADD
      <?=$page_name3;?>
      <span class="fr">
      <button class="button-blue" onClick="window.location.href='pharma_registration'"><i class="fa fa-th-list fa-lg"></i> Manage
      <?=$page_name3;?>s</button>
      </span> </h3>
  </div>
  <div class="box addeditform">
    <form action="" method="post" name="pharma_reg_edit" id="pharma_reg_edit" enctype="multipart/form-data">
           
        <div class="row" id="ltitle">
            <span class="label">Name of the Pharma<span class="red"> *</span></span>
            <span class="item">
            <?php  echo $pharma_data['pharma_name'];?></span>
            <div class="clear"></div>
        </div>
        ...
        <div class="row" id="ltitle">
            ...
            <span class="item">
            <?php  echo $pharma_data['pharma_refno'];?></span>
            <div class="clear"></div>
        </div>
        ...
        <div class="row" id="ltitle">
            ...
            <span class="item">
            <?php  echo $pharma_data['pharma_mobile'];?></span>
            <div class="clear"></div>
        </div>
        <div class="row" id="ltitle">
        <span class="label">Hospital / Clinic Name <span class="red">*</span></span>
            <span class="item">
            <input name="pharma_hosname" id="pharma_hosname" Type="text" 
             value="<? 
            if(isset($_POST['pharma_hosname'])) { 
                echo $_POST['pharma_hosname']; 
                }else { 
                    echo $row['pharma_hosname'];
                    } ?>" required >
            </span> 
            <div class="clear"></div>
        </div>
        ...
        <span class="label">Aadhar No <span class="red">*</span></span>
            <span class="item">
            <input name="pharma_aadhaar" id="pharma_aadhaar" type="text" minlength="12" maxlength="12" 
            onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 43"
             value="<? 
            if(isset($_POST['pharma_aadhaar'])) { 
                echo $_POST['pharma_aadhaar']; 
                }else { 
                    echo $row['pharma_aadhaar'];
                    } ?>" required>
            </span> 
            <div class="clear"></div>
            </div>
        ...
        <span class="label">GST No </span>
            <span class="item">
            <input name="pharma_gst" id="pharma_gst" type="text" minlength="15"  maxlength="15" 
             value="<? 
            if(isset($_POST['pharma_gst'])) { 
                echo $_POST['pharma_gst']; 
                }else { 
                    echo $row['pharma_gst'];
                    } ?>" >
            </span> 
        ...
        <span class="label">PAN CARD <span class="red"></span></span>
            <span class="item">
            <input name="pharma_pan" id="pharma_pan" type="text"
             value="<? 
            if(isset($_POST['pharma_pan'])) { 
                echo $_POST['pharma_pan']; 
                }else { 
                    echo $row['pharma_pan'];
                    } ?>">
            </span> 
        ...
        <span class="label">EMAIL ID <span class="red"></span></span>
            <span class="item">
            <input name="pharma_email" id="pharma_email" type="text"
             value="<? 
            if(isset($_POST['pharma_email'])) { 
                echo $_POST['pharma_email']; 
                }else { 
                    echo $row['pharma_email'];
                    } ?>">
            </span> 
            <div class="clear"></div>
        </div>
	...
	<div class="row" id="ltitle">
        ...
        <span class="label">Postal Addrass <span class="red">*</span></span>
            <span class="item">
            <input name="pharma_postadd" id="pharma_postadd" type="text"
             value="<? 
            if(isset($_POST['pharma_postadd'])) { 
                echo $_POST['pharma_postadd']; 
                }else { 
                    echo $row['pharma_postadd'];
                    } ?>" required>
            </span> 
            <div class="clear"></div>
        </div>
