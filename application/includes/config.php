...
//Local
$baseurl	= 'http://localhost/ytoaprana/application/';
$baseurl_front	= 'http://localhost/ytoaprana/';
//Live
//$baseurl	= 'http://'.$_SERVER['SERVER_NAME'].'/application/';
...
define("LOGO", "images/ytoaprana.png");
define("TITLE", "Y to A - Prana Health Care Private Limited - Admin Panel");
define("ERPLOGO", "images/rlk-logo.jpeg");
define("ERPTITLE", "WebERP4");
// Mail Ids
define("MASTER_MAIL", "technical@ytoa-prana.com");
define("FROM_MAIL", "support@ytoa-prana.com");
define("FROM_NAME", "Y to A - Prana Health Care Private Limited - www.ytoa-prana.com");
		...
		<table align='center' width='760' cellpadding='0' cellspacing='1' bgcolor='#AECDF6' bordercolor='#DDF0FD' border='5'>
		  <tr>
			<td bgcolor='#FFFFFF'><table width='100%'  border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'>
			  <tr>
				<td><a href='/ytoaprana/application/' target='_blank'><img src='".BASEURL.LOGO."' alt='".TITLE."'></a></td>
			  </tr>
			  <tr>
