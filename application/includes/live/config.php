...
//Local
$baseurl	= 'http://'.$_SERVER['SERVER_NAME'].'/bairisons_panel/';
//$baseurl_front	= 'http://'.$_SERVER['SERVER_NAME'].'/';
$baseurl_front	= 'http://localhost/bairisons.com/';
//Live
//$baseurl	= "http://'.$_SERVER['SERVER_NAME'].'/dev/bcp_viswastrology/";
//$baseurl_front	= "http://'.$_SERVER['SERVER_NAME'].'/dev";
...
define("LOGO", "images/bairisons.png");
define("TITLE", "Bairisons Admin Panel");
define("ERPLOGO", "images/logo_erp4.gif");
define("ERPTITLE", "WebERP4");
// Mail Ids
define("DEV_MAIL", "lokesh@bitragroup.com");
define("MASTER_MAIL", "lokesh@bitragroup.com");
define("FROM_MAIL", "lokesh@bitragroup.com");
define("FROM_NAME", " Team");
define("BCC_MAIL", "lokesh@bitragroup.com");
...
//$config['sitearr']=array("site_tit"=>FROM_NAME,"site_url"=>"http://www.stirasthi.com/","logo"=>"logo_application.png");
...
$config['gall_cat']=array("1"=>"Photo Gallery","News-Articles Gallery");
		...
		<table align='center' width='760' cellpadding='0' cellspacing='1' bgcolor='#AECDF6' bordercolor='#DDF0FD' border='5'>
		  <tr>
			<td bgcolor='#FFFFFF'><table width='100%'  border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'>
			  <tr>
				<td><a href='https://bairisons.com/' target='_blank'><img src='".BASEURL.LOGO."' alt='".TITLE."'></a></td>
			  </tr>
			  <tr>
