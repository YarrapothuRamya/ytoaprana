...
<?php 
	$docdtls=get_data("ytoa_doctor","*","doc_id=".$_GET['did']);
    ...
    <section>
        <div class="container">
            <div class="row">
              ...
              <div class="col-lg-4">
                <aside class="doctor">
				<?php if(empty($docdtls['image']))
						$image="noavatar.png";
					else
						$image=$docdtls['image'];
				?>

                  <figure class="doctor-portrait"><img src="uploads/doctor_photos/<?=$image?>" alt="<?=ucfirst($docdtls['doc_name'])?>"></figure>
                  <div class="doctor-caption">
                    <h3>Dr. <?=ucfirst($docdtls['doc_name'])." ".ucfirst($docdtls['doc_lname'])?></h3>
                    <p class="profession"><?=$speciality?></p>
                    <hr class="d-divider">
                    <p><?=ucfirst($docdtls['doc_singleline'])?></p>
                    <hr class="d-divider">
              ...
              <div class="col-lg-8 space-break">
                <div class="doctor-information">
                  <h3>About Doctor</h3>
                  <hr class="d-divider">
                  <p><?=$docdtls['doc_about']?></p>
                    
                  <h3>Experience</h3>
                  <hr class="d-divider">
                  <h4><?=$docdtls['doc_exptitle']?></h4>
                  <p><?=$docdtls['doc_expdtls']?></p>
                    
                  <h3>Contact Doctor Dr. <?=$docdtls['doc_name']?></h3>
                  <hr class="d-divider">
                  <div class="contact-doctor">
                    <form method="post" action="doctor_mail.php">
                        <div class="messages"></div>
                        <div class="controls">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input id="form_name" type="text" name="doccon_name" class="form-control customize-contact" placeholder="Name" required="required" data-error="Firstname is required.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input id="form_email" type="email" name="doccon_email" class="form-control customize-contact" placeholder="Email address" required="required" data-error="Valid email is required.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea id="form_message" name="doccon_message" class="form-control customize-contact" placeholder="Your message" rows="6" required="required" data-error="Please,leave us a message."></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
<input id="doc_id" type="hidden" name="doccon_docid" class="form-control customize-contact" placeholder="Doctor ID" required="required" value="<?=$_GET['did']?>" data-error="Doctor ID is required.">
                            </div>
                            <div class="row">
