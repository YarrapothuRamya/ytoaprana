...
<?php
	...
	{
		if($row['doc_reg_subcat']>0) {
	$speciality=getdata("ytoa_regsub_cat","regsubc_name","regsubc_status=1 and regsubc_id=".$row['doc_reg_subcat']);
		}
		else
		{
	$speciality=getdata("ytoa_regcat","regcat_name","regcat_status=1 and regcat_id=".$row['doc_reg_cat']);
		}
?>
			<div class="col-md-4 col-lg-4" style="float:left">
                <div class="team-portrait">
					...
					<?php if(empty($row['image']))
								...
								$image=$row['image'];
					?>
					<img src="uploads/doctor_photos/<?=$image?>" alt=""></a>
					</figure>
                    <div class="tp-caption">
					 ...
					 <!--p><input type="text" value="www.ytoa-prana.com/doctor_view.phpdid=<?//=$row['doc_id']?>" id="myInput" readonly></p>
					 
					 <button onclick="copyToClipboard()"><img src="img/images/copylink.png"></button></p><!---->
                      <div class="span-social">
					    <button class="copy-link" title="Copy Link" link="www.ytoa-prana.com/doctor_view.php?did=<?=$row['doc_id']?>"><img src="img/images/copylink.png"></button> 
                        <!--div class="social-icon"><p><a href="<?//=$row['doc_instagram']?>" target="_blank"><i class="fab fa-instagram"></i></a></p>
						</div-->
                      </div>
                    </div>
                </div>
