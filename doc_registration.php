...
<div style="background-image: url('img/gallery/doc_pat.png');     height: 500px; 
    ...
    <section>
        <div class="container">
<form method="POST" action="docreg_mail.php" enctype = "multipart/form-data">    
            <div class="row">
              ...
              <div class="col-lg-4">
                <aside class="doctor">
                  <!--figure class="doctor-portrait"><img src="img/doctors/noavatar.png" alt=""></figure-->
                    ...
                    <p class="profession">
						<select name="doc_reg_cat" id="doc_reg_cat" class="form-control customize-contact sel_category" required="required" data-error="Registration Category is required.">
						<option>--Please select Department--</option>
                                <?php dropdown('ytoa_regcat', 'regcat_id,regcat_name', 'regcat_status=1 order by regcat_name', @$row['ls_regcat_id']); ?>
						</select>
					</p>
                    <p class="profession">
						<select name="doc_reg_subcat" id="doc_reg_subcat" class="form-control customize-contact sel_category" required="required" data-error="Specialization is required.">
						<option>--Please select Specialization--</option>
                                <?php //dropdown('ytoa_regsub_cat', 'regsubc_id,regsubc_name', 'regsubc_status=1 order by regsubc_name', @$row['ls_regsubc_id']); ?>
						</select>
					</p>
                    <hr class="d-divider">
                    <p>
              ...
              <div class="col-lg-8 space-break">
                <div class="doctor-information">
                    ...
                    <div class="contact-list">
                        ...
                        <p class="phone">+ 91 
                            <input id="form_phone" type="tel" name="doc_phone" class="form-control customize-contact" placeholder="Please enter Phone Contact" required="required" >
						</p>  
                        <p class="mail">
