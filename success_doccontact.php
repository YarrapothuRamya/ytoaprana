            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="contact-info">
                    ...
                    <h2 align="center">Successfully Sent Your Message!</h2>
					<div class="row">
						<div class="col-md-12 submit-btn">
							<p><a href="index.php" class="btn btn-custom">Back to Home Page</a></p>
						</div>
					</div>
					<br>
					<h6 align="right">- Y to A - Prana Health Services Team</h6>
                </div>  
              </div>
            </div>
        </div>
