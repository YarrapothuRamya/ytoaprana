...
$cat_id=$_POST['cat_id'];
$cat_details=get_data('ytoa_emergencycat','*','emergencycat_id='.$cat_id);
$title=$cat_details['emergencycat_name']." Registration";
...
if(isset($_POST['submit']))
{
	...
	$mobile="";
	$reg_count=getdata("ytoa_emergency","count(*)","emergency_phone='".$_POST['mobile']."'");
