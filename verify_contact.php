...
$cat_details=get_data('ytoa_regcat','*','regcat_id='.$cat_id);
$title=$cat_details['regcat_name']." Registration";
...
if(isset($_POST['submit']))
{
	...
	$mobile="";
	$reg_count=getdata("ytoa_doctor","count(*)","doc_phone='".$_POST['mobile']."'");
	...
	$text_message="Dear%20".$number.",%20Please%20Enter%20OTP%20".$otp."%20to%20verify%20your%20contact%20number%20for%20registration%20-%20YtoA-Prana%20Health%20Care%20Private%20Limited";
		...
		$_SESSION['subcatid']=$_POST['subcat_id'];
    ...
    <div class="sections">
        <div class="container">
            <div class="pages-title">
                <h1><?=$portal_dtls['p_title'] ?><br> <span>Verify Contact</span></h1>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
										...
										<input type="hidden" name="subcat_id" value="<?=$subcat_id?>" readonly>
