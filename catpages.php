...
<?php   
		$cat_name=getdata("ytoa_regcat","regcat_name","regcat_id=".$cat_id);
?>
<div style="background-image: url('<?php get_cat_titimage($cat_id); ?>');     
	height: 500px; 
    ...
    <div class="sections">
        <div class="container">
            <div class="pages-title">
                <h1>Y to A - Prana<br> <span><?=$cat_name?></span></h1>
                <p><a href="#">Home</a> &nbsp; > &nbsp; <a href="catpages.php?cat_id=<?=$cat_id?>"><?=$cat_name?></a></p>
            </div>
        </div>  
    </div>
</div>	
    ...
    <section>
        <div class="container">
            <div class="row">
              <div class="col-lg-6"><figure class='about-us-alt-img'><?php get_cat_image($cat_id); ?></figure>
              </div>
              <div class="col-lg-6 space-break">
                <div class="about-us-alt-info">
				 ...
				 <form name="" method="POST" action="verify_mobile.php">
						<input type="hidden" name="cat_id" value="<?=$cat_id?>">
						Not a Member? <button type="register" class="btn btn-custom">Register</button><br>
						Already you are Member? <button type="login" class="btn btn-custom">Login</button><br>
				</form>
				
				  <?php get_cat_details($cat_id); ?>
        ...
        <div class="container-fluid inner-color">
            <div class="container">
                <div class="section-title">
                    <h2>Our Team</h2>
                    <p>We specialise in <?=$cat_name?>!</p>
                </div>
                <div class="team-carousel slider hover-effects image-hover">
<?php
		$doc_regcat=Query("select * from ytoa_doctor where doc_reg_cat=".$cat_id);
		while($doc_lst=Fetch($doc_regcat)) {

?>
                  <div class="slide">
                     <div class="team-portrait">
                        <a href="doctor_view.php?did=<?=$doc_lst['doc_id']?>">
						<figure class="tp-avatar"><img src="img/doctors/noavatar.png" alt=""></figure>
