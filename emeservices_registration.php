...
<div style="background-image: url('img/gallery/emeservices.jpg');     height: 500px; 
    ...
    <div class="sections">
        <div class="container">
            <div class="pages-title">
                <h1><?=$portal_dtls['p_title'] ?><br> <span>Emergency Services - Registration</span></h1>
                <p><a href="#">Home</a> &nbsp; > &nbsp; <a href="emeservices_registration.php">Emergency Services Registration</a></p>
            </div>
        </div>  
    </div>
</div>	
    ...
    <section>
        <div class="container">
<form method="POST" action="emergencyreg_mail.php" enctype = "multipart/form-data" onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Please indicate that you have read and agree to the Terms and Conditions and Privacy Policy'); return false; }">    
            <div class="row">
                ...
                <aside class="doctor">
                  ...
                  <!--figure class="doctor-portrait"><img src="img/doctors/noavatar.png" alt=""></figure-->
					<div class="doctor-caption">
						<p>M/s.</p><input id="form_name" type="text" name="emergency_name" class="form-control customize-contact" placeholder="Emergency Service Name" required="required" data-error="Emergency Services - Name is required.">
						<p>Emergency Service Image</p>
						<input name="image" id="image" type="file" value="" class="btn btn-custom"><br>
                        <span><p>(Max Size 1MB)</p></span>
                    <p class="profession">
						<select name="emergency_reg_cat" id="emergency_reg_cat" class="sel_category form-control customize-contact" required="required" data-error="Emergency Services Category is required.">
							<option>--Select Department</option>
                                <?php dropdown('ytoa_emergencycat', 'emergencycat_id,emergencycat_name', 'emergencycat_status=1 order by emergencycat_name', @$row['ls_emergencycatid']); ?>
						</select>
					</p>
...
<div class="emeservices-information">
                    <div class="contact-list">
                        ...
                        <p class="phone">+ 91 <?echo $_SESSION['username']?>
                            <input id="form_phone" type="hidden" name="emergency_phone" class="form-control customize-contact" placeholder="Phone Contact" required="required" value="<?=$_SESSION['username']?>" readonly>
						</p>  
                        <p class="mail">
...
$(document).ready( function() {
   	$('.sel_category').on('change', function(){		
		...
		var sel_id=this.id; 
//         alert(sel_id);
		if(sel_id=="emergency_reg_cat") { 
			var dataString = 'emergencycat_id='+val+'&drop=emergencycat'; var result_ls="#emergency_reg_subcat";
		}
