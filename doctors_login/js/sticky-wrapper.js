...
jQuery(document).ready(function($){$(".topwrap").sticky({topSpacing:0});$(".menuwrap").sticky({topSpacing:30});});
...
function CheckIdleTime(){
    ...
    if (_idleSecondsCounter >= IDLE_TIMEOUT){
        //var r = confirm("Time expired!");
        //if(r == true){
			document.location.href = "logout_idle.php";
		//}else{
