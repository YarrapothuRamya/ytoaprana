...
if($_SESSION['ERP_Sup_id']==1){ $sub_qur.=""; }else if($_SESSION['ERP_Sup_id']==2){ $sub_qur.=" and sup_code IN ('".$_SESSION['ERP_Sup_code']."')"; }else{ $sub_qur.=" and sup_id=".$_SESSION['ERP_Uid'];} 
...
if(isset($_SESSION['ser_keyword'])){ $sub_qur.=" and (sup_fname like '%".$_SESSION['ser_keyword']."%' or sup_lname like '%".$_SESSION['ser_keyword']."%' or sup_email like '%".$_SESSION['ser_keyword']."%' or sup_phone like '%".$_SESSION['ser_keyword']."%')"; }

if(!empty($_GET['status'])) { $status_id=$_GET['status']; $sub_qur.=" and sup_status=".$_GET['status']; } else { $status_id=""; }
include(RNSTM);
?>
